...
## Set 5
- [x] 1. WAP to read data from keyboard
         write it to the file. 
		 After writing is completed, 
		 the file is closed. 
		 The program again opens the same file and 
		 reads it.
...
- [x] 4. Create two classes namely Employee and Qualification. Using multiple inheritance derive two classes Scientist and anager. 
         Take suitable attributes & operations. WAP to implement this class hierarchy.

- [x] 5. Use concept of classes and object to create a website for playing movie trailer. 
...
- [x] 6. Write a Python program to read text from a file. Find out occurrence of each word in dictionary. 
        Create a graphical representation of the same using a bar chart. Give label to chart, x-axis and y-axis. 
